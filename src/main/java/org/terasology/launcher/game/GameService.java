 ...
 * </ul>
 */
// gamePath/settings set post-construction via start(), not the constructor (see javadoc).
// createTask() guards with verifyNotNull since bare start() can still be called unconfigured.
