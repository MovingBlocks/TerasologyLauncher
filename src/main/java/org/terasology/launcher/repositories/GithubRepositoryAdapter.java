...
public class GithubRepositoryAdapter implements ReleaseRepository {
    ...
    public GithubRepositoryAdapter() {
        try {
            github = GitHub.connect("skaldarnar", "b6f05ee18cb7f88e7060524a4c00afd8d866b867");
    ...
    static GameRelease fromGithubRelease(GHRelease ghRelease) {
        ...
        try {
            ...
            return new GameRelease(new GameIdentifier(version, build, profile, null), url, changelog, null);
        } catch (IOException e) {
