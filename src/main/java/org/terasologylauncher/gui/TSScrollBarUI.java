...
/**
 * Custom scroll bar style to fit into the launcher. The scroll bar is a custom design with just a dark grey thumb element with rounded
 * corners and no background.
 *
 * @author Skaldarnar
 */
