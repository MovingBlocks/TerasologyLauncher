...
public final class GameDownloader extends SwingWorker<Void, Void> {
    ...
    public GameDownloader(final JProgressBar progressBar, final LauncherFrame frame, final Settings settings,
        ...
        progressBar.setString(BundleUtils.getLabel("update_startDownload"));
    ...
    protected void done() {
        ...
        progressBar.setString(BundleUtils.getLabel("update_extractZip"));
        ...
        progressBar.setString(BundleUtils.getLabel("update_gameInfo"));
        progressBar.setStringPainted(true);
